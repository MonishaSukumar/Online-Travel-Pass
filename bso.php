...
<center>
<form action="boview.php" method="post">
<a href="bothers.php"><button type="button" class="btn"  type="button">Registration </button><br><br></a>
<a href="borenew.php"><button type="button" class="btn">Renewal</button><br><br></a>
<button  type="submit" name="s"class="btn">View Profile Details</button><br><br></a>
<a href="bogen.php"><button  type="button" name="s" class="btn">Generate Pass</button><br><br></a>
