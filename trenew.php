...
<html>
<head>
<title>Train Pass Renewal</title>
...
$con=connect();
$em=$_SESSION['em'];
			$sq="Update train set renewd='$rd' where em='$em'";
			$s="Update train set py='0' where em='$em'";
            $result = $con->query($sq);
			 $r = $con->query($s);
if ($result && $r) {
...
$s="SELECT * from train where em='$em'";
            $result = $con->query($s);
...
?>
<br><a href="payt.php"><center> If Renew updated successfully proceed to payment</center></a></body>
<br><a href="tsr.php"><center>  Back </center></a></body>
</div>
     </form>
</body>
</html>