 ...
 $renewd=$dat;
		 ...
		 if($km=='4'){
		   ...
		   if($km==15){
			 ...
			 echo '<script type="text/javascript">alert("Pass can be generated within 15 kms only")</script>';
		 }
	$sql= "INSERT into busothers VALUES('" . $un . "','" . $fn . "','". $dob ."','". $gen ."','". $age ."','".$aad."','" . $em. "','". $apn."','".$ds."','". $tk."','".$cy."',
	'" . $addr. "','".$pin."','". $from."','".$to."','" . $km. "','".$m."','".$fare."','".$dat."','".$renewd."','".$py."')";
				   $success = $con->query($sql);
						if (!$success) {
							die("Couldn't enter data: ".$con->error);
										...
										header("location:bsr.php");
				}
			?>
<!DOCTYPE html>
<html>
<head>
<title>Bus Pass Registeration Below 10th</title>
...
<table align="center" cellpadding="2" cellspacing="2"  id="application" width="500px">
	<tbody><tr>
									...
									<tr>
										<td colspan="4" align="Middle" ><h2 class="ti"> General Bus Pass Application </h2></td>
									</tr>
									</tbody></table>
									
	<table><tr><td>
	<div id="d2">
	<button class="button"><center><h1 style="font-size:18px"><b>General Details</b></h1></center></button><br>
	<br>
		<form action="bothers.php" method="post" >
				<br><b>Name </b>
				...
				<input type="number_format" placeholder="" name="aad" required maxlength="15" size="20"><br><br>
				<b> E-mail ID </b>
				<input type="e-mail"  name="em" required  size="30"><br><br>
				<b> Application Number </b>
				<input type="number_format"  name="apn" required><br><br>
	</div></td><td>
	<div id="d1">
	...
	<input type="radio" name="km" value="4"><=4kms
