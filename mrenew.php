...
<html>
<head>
<title>Metro Pass Renewal</title>
...
$con=connect();
$em=$_SESSION['em'];
			$sq="Update Metro set renewd='$rd' where em='$em'";
			$s="Update Metro set py='0' where em='$em'";
            $result = $con->query($sq);
			 $r = $con->query($s);
if ($result && $r) {
...
$s="SELECT * from Metro where em='$em'";
            $result = $con->query($s);
...
?>
<br><a href="pay.php"><center> If Renew updated successfully proceed to payment</center></a></body>
<br><a href="msr.php"><center>  Back </center></a></body>
</div>
     </form>
</body>
</html>