...
$renewd=$dat;
	...
	$sql= "INSERT into Metro VALUES('" . $un . "','" . $fn . "','". $dob ."','". $gen ."','". $age ."','".$aad."','" . $em. "','". $apn."','".$ds."','". $tk."','".$cy."',
				   ...
				   $success = $con->query($sql);
						if (!$success) {
							die("Couldn't enter data: ".$con->error);
										...
										echo '<script type="text/javascript">alert("Registeration for Metro Pass is Successfull")</script>';
...
<html>
<head>
<title>Metro Pass Registeration Below 10th</title>
<link rel="stylesheet" href="css/sslc.css">
<link  rel="shortcut icon" href="images/Metro.jpg" type="image/png">
</head>
<body style="background-color: #17202A ">
<table align="center" cellpadding="2" cellspacing="2"  id="application" width="500px">
	<tbody><tr>
										<td align="center"><img src="images/Metro.jpg" width="120px" height="80px" align="middle"></td>	
										<td colspan="4" align="center" style="font-size:45px" class="tit"><b>METRO   PASS   ONLINE</b> </font> <br>  </td>
									</tr>
									<tr>
										<td colspan="4" align="Middle" ><h2 class="ti"> Employee Metro Pass Application  </h2></td>
									</tr>
									</tbody></table>
									
	<table><tr><td>
	<div id="d2">
	<button class="button"><center><h1 style="font-size:18px"><b>Employee Details</b></h1></center></button><br>
	<br>
		<form action="mereg.php" method="post" >
				<br><b>Name </b>
	...
	<tr><td><div id="d2">
	<button class="button"><center><h1 style="font-size:18px"><b>Company Details</b></h1></center></button><br>
	<br>
		<form action="bb101.php" method="post">
				<b>Company Name </b>
	...
	<div id="d1">
	<button class="button"><center><h1 style="font-size:18px"><b>Metro Station Details</b></h1></center></button><br>
	<br>
