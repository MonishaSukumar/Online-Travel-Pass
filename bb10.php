...
$renewd=$dat;
		 ...
		 if($age<=16){
	$sql= "INSERT into busb10 VALUES('" . $un . "','" . $fn . "','". $dob ."','". $gen ."','". $age ."','".$aad."','" . $em. "','". $apn."','".$ds."','". $tk."','".$cy."',
						...
						if (!$success) {
							die("Couldn't enter data: ".$con->error);
										...
										header("location:bsb.php");
											...
											echo '<script type="text/javascript">alert("Incorrect age")</script>';
										}}
...
<table align="center" cellpadding="2" cellspacing="2"  id="application" width="500px">
	<tbody><tr>
									...
									<tr>
										<td colspan="4" align="Middle" ><h2 class="ti"> Student Bus Pass Application Below 10th </h2></td>
									</tr>
									</tbody></table>
	...
	<br>
		<form action="bb10.php" method="post" >
				<br><b>Name </b>
