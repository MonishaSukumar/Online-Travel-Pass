...
<table align="center" cellpadding="2" cellspacing="2"  id="application" width="500px">
	<tbody><tr>
									...
									<tr>
										<td colspan="4" align="Middle" ><h2 class="ti"> Employee Train Pass Application  </h2></td>
									</tr>
									</tbody></table>
	...
	<div id="d1">
	<button class="button"><center><h1 style="font-size:18px"><b>Railway Station Details</b></h1></center></button><br>
	<br>
