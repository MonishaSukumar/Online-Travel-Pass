...
<table align="center" cellpadding="2" cellspacing="2"  id="application" width="500px">
	...
	<br>
		<form action="borenew.php" method="post" >
	<a href=""><button  type="submit" name="s" align="center">View Details</button></a>
	<?php
if(isset($_POST['s'])){
$con=connect();
$em=$_SESSION['em'];
			$sql="SELECT * from Busothers where em='$em'";
...
?>
<br><a href="paybo.php"><center> If Renew updated successfully proceed to payment</center></a></body>
